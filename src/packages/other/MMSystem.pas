...
type
  ...
  TMCI_Open_Parms = {$ifdef UNICODE}TMCI_Open_ParmsW{$else}TMCI_Open_ParmsA{$endif};
...
type
  ...
  TMCI_Info_Parms = {$ifdef UNICODE}TMCI_Info_ParmsW{$else}TMCI_Info_ParmsA{$endif};
...
type
  ...
  TMCI_SysInfo_Parms = {$ifdef UNICODE}TMCI_SysInfo_ParmsW{$else}TMCI_SysInfo_ParmsA{$endif};
...
type
  ...
  TMCI_SaveParms = {$ifdef UNICODE}TMCI_SaveParmsW{$else}TMCI_SaveParmsA{$endif};
...
type
  ...
  TMCI_Load_Parms = {$ifdef UNICODE}TMCI_Load_ParmsW{$else}TMCI_Load_ParmsA{$endif};
...
type
  ...
  TMCI_VD_Escape_Parms = {$ifdef UNICODE}TMCI_VD_Escape_ParmsW{$else}TMCI_VD_Escape_ParmsA{$endif};
...
type
  ...
  TMCI_Wave_Open_Parms = {$ifdef UNICODE}TMCI_Wave_Open_ParmsW{$else}TMCI_Wave_Open_ParmsA{$endif};
...
type
  ...
  TMCI_Anim_Open_Parms = {$ifdef UNICODE}TMCI_Anim_Open_ParmsW{$else}TMCI_Anim_Open_ParmsA{$endif};
...
type
  ...
  TMCI_Anim_Window_Parms = {$ifdef UNICODE}TMCI_Anim_Window_ParmsW{$else}TMCI_Anim_Window_ParmsA{$endif};
...
type
  ...
  TMCI_Ovly_Open_Parms = {$ifdef UNICODE}TMCI_Ovly_Open_ParmsW{$else}TMCI_Ovly_Open_ParmsA{$endif};
...
type
  ...
  TMCI_Ovly_Window_Parms = {$ifdef UNICODE}TMCI_Ovly_Window_ParmsW{$else}TMCI_Ovly_Window_ParmsA{$endif};
...
type
  ...
  TMCI_Ovly_Save_Parms = {$ifdef UNICODE}TMCI_Ovly_Save_ParmsW{$else}TMCI_Ovly_Save_ParmsA{$endif};
...
type
  ...
  TMCI_Ovly_Load_Parms = {$ifdef UNICODE}TMCI_Ovly_Load_ParmsW{$else}TMCI_Ovly_Load_ParmsA{$endif};
